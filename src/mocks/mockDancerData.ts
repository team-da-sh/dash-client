export const DANCER_DATA = {
  ...
  nickname: '박재연',
  detail: 'This teacher specializes in various dance forms and has vast experience. 안녕하세요, 안무가 바다입니다. 춤을 통해 제 에너지를 표현하고, 많은 사람들에게 감동을 전하는 것을 목표로 활동하고 있어요. 힙합과 팝핑을 주 장르로 삼아 다양한 무대에서 퍼포먼스를 선보이며, 국내외 아티스트와의 협업을 통해 안무가로서도 성장해 왔습니다. 춤을 사랑하는 마음으로 꾸준히 도전하며, 제 춤이 여러분에게 영감을 줄 수 있기를 바랍니다. 앞으로도 더 많은 무대에서 멋진 모습을 보여드릴게요! ',
  imageUrls: [
  ...
  genres: ['HIPHOP', 'CHOREOGRAPHY', 'KPOP', 'BRAKING'],
  lessons: [
    {
      id: 1,
      genre: 'HIPHOP',
