...
const Login = () => {
  const { Funnel, Step, setStep } = useFunnel(5, ROUTES_CONFIG.home.path);
  ...
  return (
    <>
      <LoginHeader />
      <ProgressBar totalStep={4} currentStep={1} className={progressBarStyle} />
