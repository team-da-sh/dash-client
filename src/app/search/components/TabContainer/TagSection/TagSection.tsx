...
import BottomSheet from '@/app/search/components/TabContainer/TagSection/BottomSheet/BottomSheet';
import {
  tagCustomStyle,
  containerStyle,
  tagWrapperStyle,
} from '@/app/search/components/TabContainer/TagSection/tagSection.css';
