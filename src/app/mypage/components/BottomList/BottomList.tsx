...
import { GOOGLE_FORM_LINK } from '@/app/mypage/constants/link';
import type { BottomListItem } from '@/app/mypage/utils/getBottomList';
import { getBottomListData } from '@/app/mypage/utils/getBottomList';
