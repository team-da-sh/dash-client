...
import { usePostWithdraw } from '@/app/mypage/withdraw/apis/queries';
import {
  containerStyle,
  titleStyle,
  descriptionStyle,
  ...
  bulletItemStyle,
  agreeSectionStyle,
} from '@/app/mypage/withdraw/components/NoticeStep/noticeStep.css';
import { NOTICE_CONTENTS } from '@/app/mypage/withdraw/constants';
