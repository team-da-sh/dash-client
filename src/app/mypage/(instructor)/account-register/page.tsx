...
import * as styles from '@/app/mypage/(instructor)/account-register/index.css';
import { accountRegisterSchema } from '@/app/mypage/(instructor)/account-register/schema/accountRegisterSchema';
