...
import {
  ...
  errorMessageStyle,
} from '@/app/mypage/(instructor)/class-register/components/ClassRepresentImage/classRepresentImage.css';
import Description from '@/app/mypage/(instructor)/class-register/components/Description';
import { CLASS_REPRESENT_IMAGE_SUBTITLE } from '@/app/mypage/(instructor)/class-register/constants/registerSectionText';
