...
import {
  ...
  textareaFooterStyle,
} from '@/app/mypage/(instructor)/class-register/components/ClassDescription/classDescription.css';
import Description from '@/app/mypage/(instructor)/class-register/components/Description';
import { MAX_CLASS_DESCRIPTION_LENGTH } from '@/app/mypage/(instructor)/class-register/constants/formLimit';
import {
