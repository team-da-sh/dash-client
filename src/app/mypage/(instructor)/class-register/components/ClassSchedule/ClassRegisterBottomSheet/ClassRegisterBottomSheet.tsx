...
import * as styles from '@/app/mypage/(instructor)/class-register/components/ClassSchedule/ClassRegisterBottomSheet/classRegisterBottomSheet.css';
import ClassRegisterFunnel from '@/app/mypage/(instructor)/class-register/components/ClassSchedule/ClassRegisterFunnel/ClassRegisterFunnel';
import { useLocalFunnel } from '@/app/mypage/(instructor)/class-register/hooks/useLocalFunnel';
