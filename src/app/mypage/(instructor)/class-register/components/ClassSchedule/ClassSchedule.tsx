...
import {
  ...
  scheduleInfoStyle,
  errorMessageStyle,
} from '@/app/mypage/(instructor)/class-register/components/ClassSchedule/classSchedule.css';
import Description from '@/app/mypage/(instructor)/class-register/components/Description';
import { CLASS_SCHEDULE_SUBTITLE } from '@/app/mypage/(instructor)/class-register/constants/registerSectionText';
import type { TimesTypes } from '@/app/mypage/(instructor)/class-register/types/classSchedule';
