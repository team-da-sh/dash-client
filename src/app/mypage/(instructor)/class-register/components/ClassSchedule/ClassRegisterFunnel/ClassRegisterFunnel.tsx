import { funnelContainerStyle } from '@/app/mypage/(instructor)/class-register/components/ClassSchedule/ClassRegisterFunnel/classRegisterFunnel.css';
import DateStep from '@/app/mypage/(instructor)/class-register/components/ClassSchedule/DateStep/DateStep';
import TimeStep from '@/app/mypage/(instructor)/class-register/components/ClassSchedule/TimeStep/TimeStep';
