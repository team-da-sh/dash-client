...
import TimeControl from '@/app/mypage/(instructor)/class-register/components/ClassSchedule/TimeStep/TimeControl/TimeControl';
import {
  timeStepControlsRowStyle,
  timeStepMessageWrapperStyle,
  timeStepTagListStyle,
  timeStepWrapperStyle,
} from '@/app/mypage/(instructor)/class-register/components/ClassSchedule/TimeStep/timeStep.css';
