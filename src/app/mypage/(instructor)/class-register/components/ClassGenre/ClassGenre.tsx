...
import {
  ...
  buttonWrapperStyle,
  errorMessageStyle,
} from '@/app/mypage/(instructor)/class-register/components/ClassGenre/classGenre.css';
import Description from '@/app/mypage/(instructor)/class-register/components/Description';
import { CLASS_GENRE_SUBTITLE } from '@/app/mypage/(instructor)/class-register/constants/registerSectionText';
