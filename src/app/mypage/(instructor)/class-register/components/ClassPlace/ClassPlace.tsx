...
import {
  ...
  errorMessageStyle,
} from '@/app/mypage/(instructor)/class-register/components/ClassPlace/classPlace.css';
...
import type { LocationsData, LocationTypes } from '@/app/mypage/(instructor)/class-register/types/index';
