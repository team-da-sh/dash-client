...
import { useLessonApproveMutation, useLessonCancelMutation } from '@/app/mypage/(instructor)/classes/[id]/apis/queries';
import * as styles from '@/app/mypage/(instructor)/classes/[id]/components/StudentCard/studentCard.css';
