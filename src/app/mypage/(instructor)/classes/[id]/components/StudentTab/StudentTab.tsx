...
import StudentList from '@/app/mypage/(instructor)/classes/[id]/components/StudentList/StudentList';
import {
  emptyTextStyle,
  tabListStyle,
  tabPanelStyle,
} from '@/app/mypage/(instructor)/classes/[id]/components/StudentTab/StudentTab.css';
