...
import {
  ...
  sectionStyle,
  inputWrapperStyle,
} from '@/app/mypage/(instructor)/profile-register/components/PersonalSNSSection/personalSNSSection.css';
import { INSTRUCTOR_REGISTER_PLACEHOLDER } from '@/app/mypage/(instructor)/profile-register/constants/registerSection';
