...
import { useGetNicknameDuplicate } from '@/app/mypage/(instructor)/profile-register/apis/queries';
import * as styles from '@/app/mypage/(instructor)/profile-register/components/DancerNameSection/dancerNameSection.css';
import {
  FORM_ERROR_MESSAGE,
...
} from '@/app/mypage/(instructor)/profile-register/types/instructorRegisterForm';
