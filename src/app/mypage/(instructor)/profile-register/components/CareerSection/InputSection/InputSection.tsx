...
} from '@/app/mypage/(instructor)/profile-register/components/CareerSection/careerSection.css';
import type { InputItemTypes } from '@/app/mypage/(instructor)/profile-register/types/inputItemTypes';
