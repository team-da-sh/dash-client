...
import InputSection from '@/app/mypage/(instructor)/profile-register/components/CareerSection/InputSection/InputSection';
import Description from '@/app/mypage/(instructor)/profile-register/components/Description/Description';
import { sectionStyle } from '@/app/mypage/(instructor)/profile-register/components/VideoLinkSection/videoLinkSection.css';
import {
  INSTRUCTOR_REGISTER_FORM_KEY,
  INSTRUCTOR_REGISTER_PLACEHOLDER,
  MAX_VIDEO_INPUT_COUNT,
} from '@/app/mypage/(instructor)/profile-register/constants/registerSection';
import type { instructorRegisterFormTypes } from '@/app/mypage/(instructor)/profile-register/types/instructorRegisterForm';
