...
import {
  ...
  usePostInstructor,
} from '@/app/mypage/(instructor)/profile-register/apis/queries';
import { instructorRegisterSchema } from '@/app/mypage/(instructor)/profile-register/schema/instructorRegisterSchema';
import type { InstructorRegisterInfoResponseTypes } from '@/app/mypage/(instructor)/profile-register/types/api';
import type {
  duplicateStateTypes,
