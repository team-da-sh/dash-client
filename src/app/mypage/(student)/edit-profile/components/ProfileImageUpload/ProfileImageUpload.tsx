...
import BottomSheet from '@/app/mypage/(student)/edit-profile/components/BottomSheet/BottomSheet';
import * as styles from '@/app/mypage/(student)/edit-profile/components/ProfileImageUpload/profileImageUpload.css';
