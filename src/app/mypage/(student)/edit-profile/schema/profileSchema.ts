import { z } from 'zod';
import { ACCEPTED_IMAGE_TYPES, MAX_FILE_SIZE } from '@/app/mypage/(student)/edit-profile/constants/limit';
import { PROFILE_IMAGE_ERRORS } from '@/app/mypage/(student)/edit-profile/constants/validationMessage';
...
export const profileSchema = z.object({
  profileImageUrl: z.union([z.string().nullable().optional(), fileListSchema]),
