...
import { getReservationsDetail } from '@/app/mypage/(student)/reservations/[id]/apis/axios';
import type { ReservationDetailType } from '@/app/mypage/(student)/reservations/[id]/types/api';
