...
import { usePostWithdraw } from '@/app/my/withdraw/apis/queries';
import {
  containerStyle,
  titleStyle,
  descriptionStyle,
  ...
  bulletItemStyle,
  agreeSectionStyle,
} from '@/app/my/withdraw/components/NoticeStep/noticeStep.css';
import { NOTICE_CONTENTS } from '@/app/my/withdraw/constants';
