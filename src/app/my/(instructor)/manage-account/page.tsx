...
import { useGetMyPage, usePostTeacherAccount } from '@/app/my/(instructor)/manage-account/apis/queries';
import ConfirmBottomSheet from '@/app/my/(instructor)/manage-account/components/ConfirmBottomSheet/ConfirmBottomSheet';
import { ACCOUNT_REGISTER_FORM_KEY } from '@/app/my/(instructor)/manage-account/constants/registerSection';
import * as styles from '@/app/my/(instructor)/manage-account/index.css';
import { accountRegisterSchema } from '@/app/my/(instructor)/manage-account/schema/accountRegisterSchema';
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={styles.containerStyle}>
        ...
        <div className={styles.inputContainerStyle}>
          ...
          <button type="button" className={styles.bankSelectContainerStyle} onClick={() => setIsBankSheetOpen(true)}>
