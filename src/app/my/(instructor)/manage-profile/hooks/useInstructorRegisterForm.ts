...
import { usePatchInstructorRegisterInfo, usePostInstructor } from '@/app/my/(instructor)/manage-profile/apis/queries';
import { instructorRegisterSchema } from '@/app/my/(instructor)/manage-profile/schema/instructorRegisterSchema';
import type { InstructorRegisterInfoResponseTypes } from '@/app/my/(instructor)/manage-profile/types/api';
import type {
  duplicateStateTypes,
