...
import {
  ...
  sectionStyle,
  inputWrapperStyle,
} from '@/app/my/(instructor)/manage-profile/components/PersonalSNSSection/personalSNSSection.css';
import { INSTRUCTOR_REGISTER_PLACEHOLDER } from '@/app/my/(instructor)/manage-profile/constants/registerSection';
