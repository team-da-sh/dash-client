...
import { useGetNicknameDuplicate } from '@/app/my/(instructor)/manage-profile/apis/queries';
import * as styles from '@/app/my/(instructor)/manage-profile/components/DancerNameSection/dancerNameSection.css';
import {
  FORM_ERROR_MESSAGE,
