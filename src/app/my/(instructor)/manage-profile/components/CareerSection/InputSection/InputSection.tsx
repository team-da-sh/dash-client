...
} from '@/app/my/(instructor)/manage-profile/components/CareerSection/careerSection.css';
import type { InputItemTypes } from '@/app/my/(instructor)/manage-profile/types/inputItemTypes';
