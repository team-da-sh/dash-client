...
import { useGetInstructorRegisterInfo } from '@/app/my/(instructor)/manage-profile/apis/queries';
import CareerSection from '@/app/my/(instructor)/manage-profile/components/CareerSection/CareerSection';
import DancerNameSection from '@/app/my/(instructor)/manage-profile/components/DancerNameSection/DancerNameSection';
import ImageUploadSection from '@/app/my/(instructor)/manage-profile/components/ImageUploadSection/ImageUploadSection';
import IntroductionSection from '@/app/my/(instructor)/manage-profile/components/IntroductionSection/IntroductionSection';
import PersonalSNSSection from '@/app/my/(instructor)/manage-profile/components/PersonalSNSSection/PersonalSNSSection';
import VideoLinkSection from '@/app/my/(instructor)/manage-profile/components/VideoLinkSection/VideoLinkSection';
import useInstructorRegisterForm from '@/app/my/(instructor)/manage-profile/hooks/useInstructorRegisterForm';
import * as styles from '@/app/my/(instructor)/manage-profile/index.css';
