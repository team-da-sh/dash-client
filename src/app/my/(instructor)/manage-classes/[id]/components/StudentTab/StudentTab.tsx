...
import StudentList from '@/app/my/(instructor)/manage-classes/[id]/components/StudentList/StudentList';
import {
  emptyTextStyle,
  tabListStyle,
  tabPanelStyle,
} from '@/app/my/(instructor)/manage-classes/[id]/components/StudentTab/StudentTab.css';
