...
import {
  useLessonApproveMutation,
  useLessonCancelMutation,
} from '@/app/my/(instructor)/manage-classes/[id]/apis/queries';
import * as styles from '@/app/my/(instructor)/manage-classes/[id]/components/StudentCard/studentCard.css';
import type { TabStatus } from '@/app/my/(instructor)/manage-classes/[id]/types/api';
import type { Student } from '@/app/my/(instructor)/manage-classes/[id]/types/api';
