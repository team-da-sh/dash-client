...
import { useGetLessonDetail } from '@/app/my/(instructor)/manage-classes/[id]/apis/queries';
import InfoEditButton from '@/app/my/(instructor)/manage-classes/[id]/components/InfoEditButton/InfoEditButton';
import StudentTab from '@/app/my/(instructor)/manage-classes/[id]/components/StudentTab/StudentTab';
import {
  layoutStyle,
  containerStyle,
  classInfoSectionStyle,
  tabTitleStyle,
} from '@/app/my/(instructor)/manage-classes/[id]/index.css';
