...
import * as styles from '@/app/my/(instructor)/create-class/components/ClassSchedule/ClassRegisterBottomSheet/classRegisterBottomSheet.css';
import ClassRegisterFunnel from '@/app/my/(instructor)/create-class/components/ClassSchedule/ClassRegisterFunnel/ClassRegisterFunnel';
import { useLocalFunnel } from '@/app/my/(instructor)/create-class/hooks/useLocalFunnel';
