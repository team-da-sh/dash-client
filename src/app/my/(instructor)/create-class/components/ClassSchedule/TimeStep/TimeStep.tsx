...
import TimeControl from '@/app/my/(instructor)/create-class/components/ClassSchedule/TimeStep/TimeControl/TimeControl';
import {
  timeStepControlsRowStyle,
  timeStepMessageWrapperStyle,
  timeStepTagListStyle,
  timeStepWrapperStyle,
} from '@/app/my/(instructor)/create-class/components/ClassSchedule/TimeStep/timeStep.css';
