...
import {
  ...
  textareaFooterStyle,
} from '@/app/my/(instructor)/create-class/components/ClassRecommend/classRecommend.css';
import Description from '@/app/my/(instructor)/create-class/components/Description';
import { MAX_RECOMMEND_LENGTH } from '@/app/my/(instructor)/create-class/constants/formLimit';
import {
