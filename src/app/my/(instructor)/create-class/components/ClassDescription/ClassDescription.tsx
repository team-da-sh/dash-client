...
import {
  ...
  textareaFooterStyle,
} from '@/app/my/(instructor)/create-class/components/ClassDescription/classDescription.css';
import Description from '@/app/my/(instructor)/create-class/components/Description';
import { MAX_CLASS_DESCRIPTION_LENGTH } from '@/app/my/(instructor)/create-class/constants/formLimit';
import {
  CLASS_DESCRIPTION_PLACEHOLDER,
  CLASS_DESCRIPTION_SUBTITLE,
} from '@/app/my/(instructor)/create-class/constants/registerSectionText';
