...
import {
  ...
  errorMessageStyle,
} from '@/app/my/(instructor)/create-class/components/ClassPlace/classPlace.css';
...
import type { LocationsData, LocationTypes } from '@/app/my/(instructor)/create-class/types/index';
