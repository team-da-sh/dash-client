import { z } from 'zod';
import { ACCEPTED_IMAGE_TYPES, MAX_FILE_SIZE } from '@/app/my/(student)/edit-profile/constants/limit';
import { PROFILE_IMAGE_ERRORS } from '@/app/my/(student)/edit-profile/constants/validationMessage';
