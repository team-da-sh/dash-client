...
import BottomSheet from '@/app/my/(student)/edit-profile/components/BottomSheet/BottomSheet';
import * as styles from '@/app/my/(student)/edit-profile/components/ProfileImageUpload/profileImageUpload.css';
