import {
  ...
  statusWrapper,
  textStyle,
} from '@/app/my/(student)/classes/[id]/components/ReservationProgress/ReservationProgress.css';
import type { ProgressStatus, ReservationStatus } from '@/app/my/(student)/classes/types/reservationStatus';
