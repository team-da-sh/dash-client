...
import { useCancelReservation } from '@/app/my/(student)/classes/[id]/cancel-confirm/apis/query/useCancelReservation';
import {
  CANCEL_CONFIRM_DESCRIPTION,
  CANCEL_CONFIRM_MESSAGE,
} from '@/app/my/(student)/classes/[id]/cancel-confirm/constants/modalMessage';
import {
  layoutStyle,
  containerStyle,
  dividerStyle,
