...
import AccountInputSection from '@/app/my/(student)/classes/[id]/cancel/components/AccountInputSection/AccountInputSection';
import DepositeButton from '@/app/my/(student)/classes/[id]/cancel/components/DepositeButton/DepositeButton';
import {
  layoutStyle,
  containerStyle,
  scrollAreaStyle,
  ...
  buttonStyle,
} from '@/app/my/(student)/classes/[id]/cancel/index.css';
import ReservationList from '@/app/my/(student)/classes/components/ReservationList';
