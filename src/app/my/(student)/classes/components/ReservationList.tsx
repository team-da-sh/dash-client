...
import { emptyTextStyle } from '@/app/my/(instructor)/manage-classes/components/lessonList/lessonList.css';
import { useGetReservations } from '@/app/my/(student)/classes/apis/queries';
...
import { handleBoxButtonClick, handleCancelClick, handleClassCardClick } from '@/app/my/utils/clickUtils';
