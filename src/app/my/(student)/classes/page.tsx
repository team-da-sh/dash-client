...
import { useGetReservationStatus } from '@/app/my/(student)/classes/apis/queries';
import ReservationList from '@/app/my/(student)/classes/components/ReservationList';
import { options, STATUS_ENGLISH_MAP, STATUS_KOREAN_MAP } from '@/app/my/(student)/classes/constants/statusMap';
import {
  containerStyle,
  layoutStyle,
  titleStyle,
  reservationListSectionStyle,
} from '@/app/my/(student)/classes/index.css';
